...
export const regions: Region[] = [
  { id: 'riyadh', name: 'Riyadh', short: 'The heart of the kingdom', color: '#dba957', questions: [
    q('Which traditional dish is officially associated with the Riyadh Region?', 'Saleeg', 'Marqooq', 1),
  ...
  { id: 'makkah', name: 'Makkah', short: 'A city of gathering', color: '#ad7563', questions: [
    q('Which traditional dish is associated with the Makkah Region?', 'Hasawi Rice', 'Saleeg', 1),
    q('Which famous city is located in the Makkah Region?', 'Buraidah', 'Jeddah', 1),
  ...
  { id: 'jeddah', name: 'Jeddah', short: 'Bride of the Red Sea', color: '#4a8594', questions: [
    ...
    q('Jeddah is popularly nicknamed which of the following?', 'Gateway of the Gulf', 'Bride of the Red Sea', 1),
  ]},
  { id: 'madinah', name: 'Madinah', short: 'Oasis of welcome', color: '#7fa76d', questions: [
    q('Which famous mosque is located in Madinah?', 'Masjid al-Haram', 'Al-Masjid an-Nabawi', 1),
  ...
  { id: 'eastern', name: 'Eastern Province', short: 'Where the coast meets the oasis', color: '#3b9a99', questions: [
    q('What is Al-Ahsa particularly famous for?', 'Its snow-capped mountains', 'Its vast oasis and date palms', 1),
    q('Which rice dish was officially selected as the regional dish of the Eastern Province?', 'Madini Rice', 'Hasawi Rice', 1),
    q('Which natural resource has played a major role in the history and economy of the Eastern Province?', 'Gold', 'Oil', 1),
  ]},
  { id: 'qassim', name: 'Al-Qassim', short: 'Orchards, stories, and sweets', color: '#c98554', questions: [
    ...
    q('What is Al-Qassim particularly famous for producing?', 'Coffee beans', 'Dates', 1),
  ...
  { id: 'asir', name: 'Asir', short: 'Green peaks in the south', color: '#5f976f', questions: [
    q('Which traditional dish is associated with the Asir Region?', 'Sayadiyah', 'Haneeth', 1),
    q('Which city is known as the main destination and capital of the Asir Region?', 'Dammam', 'Abha', 1),
    q('What makes Asir especially unique compared with much of Saudi Arabia?', 'Its extensive sand dune deserts', 'Its mountains and green landscapes', 1),
  ]},
  { id: 'tabuk', name: 'Tabuk', short: 'Northwest horizons', color: '#7c9c9f', questions: [
    ...
    q('Tabuk is located in which part of Saudi Arabia?', 'Southeast', 'Northwest', 1),
  ...
  { id: 'hail', name: 'Hail', short: 'Poetry beneath wide skies', color: '#9f7a61', questions: [
    ...
    q('Hail is particularly famous for its connection to which aspect of traditional Arab culture?', 'Pearl diving', 'Poetry and storytelling', 1),
  ...
  { id: 'jazan', name: 'Jazan', short: 'Tropical shores and spice', color: '#d28c5e', questions: [
    q('Which dish was officially selected as the regional dish of Jazan?', 'Marqooq', 'Maghsh', 1),
    ...
    q('Which tropical fruit is commonly associated with Jazan\'s warm climate?', 'Dates', 'Mangoes', 1),
  ]},
  { id: 'najran', name: 'Najran', short: 'Southern heritage, carved in stone', color: '#ae725b', questions: [
    q('Which traditional dish was officially selected as the regional dish of Najran?', 'Muqana Bread', 'Ar-Ruqsh', 1),
    ...
    q('Which country shares a border with Najran to the south?', 'Oman', 'Yemen', 1),
  ]},
  { id: 'bahah', name: 'Al-Bahah', short: 'Mountains, forests, and song', color: '#668f7a', questions: [
    ...
    q('Which traditional bread was officially selected as the regional specialty of Al-Bahah?', 'Tamees Bread', 'Muqana Bread', 1),
  ...
  { id: 'northern-borders', name: 'Northern Borders', short: 'Winter warmth and folk strings', color: '#788d98', questions: [
    q('Which dish was officially selected as the regional dish of the Northern Borders?', 'Kleija', 'Mulayhiya', 1),
    q('Traditional dishes in the Northern Borders are especially influenced by which season?', 'Summer', 'Winter', 1),
    q('Which traditional instrument is historically associated with folk arts in the northern regions of Saudi Arabia?', 'Oud', 'Rababah', 1),
  ]},
  { id: 'jouf', name: 'Al-Jouf', short: 'Olive groves in the north', color: '#78965e', questions: [
    ...
    q('Which proverb is associated with the folk culture of Al-Jouf?', '“The rooster crows while still in the egg.”', '“He eats with his hands and feet.”', 1),
